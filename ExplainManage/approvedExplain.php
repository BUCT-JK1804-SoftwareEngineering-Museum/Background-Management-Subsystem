...
//分页
$pageSize = 3;//每一页面内容大小
$res="select * from Video where vid_status=3";
$sql=$conn->query($res);
...
$array=array();
$sql="select * from Video where vid_status=3 limit $pageSql,$pageSize";
$res=$conn->query($sql);
if ($res) {
        ...
        <div class="content">
            <div class="path">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><span style="color:orangered"><u>已审核</u></span></li>
