                ...
                <table class="table table-hover table-bordered" id="showMag">
                    ...
                    if (1) {
                        foreach($array as $v){
                            ...
                            <tr>
                                <td>内容简介</td>
                                <td><textarea style="border:white;width:490px;height:100px;overflow:auto;background-color:whitesmoke;resize:none" readonly="readonly"><?=$v["vid_info"]?></textarea></td>
                            </tr>
                            <tr>
                                <td>内容详情</td>
                            ...
                            <tr>
                                <td>Url</td>
                                <td><input style="width:400px" disabled value=<?=$v["vid_addr"]?>></td>
                            </tr>
                            <tr>
                                <td>博物馆名</td>
                                <td><?=$v["mus_name"]?></td>
                    ...
                    <tr>
                        <td>操作选项</td>
                        <td>
                            <a type='submit' class='btn' style="background-color: green" href=approve.php?vid=<?=$v["vid_id"]?>><span style="color: whitesmoke">审核通过</span></a>
                            <a type='submit' class='btn' style="background-color: red" href=disapprove.php?vid=<?=$v["vid_id"]?>><span style="color: whitesmoke">拒绝通过</span></a>
                            <a type='submit' class='btn' style="background-color: blue" href=explain.php><span style="color: whitesmoke">暂不处理</span></a>
                        </td>
                    </tr>
                </table>
            </div>
