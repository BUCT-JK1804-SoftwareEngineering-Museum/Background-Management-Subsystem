...
//分页
$pageSize = 3;//每一页面内容大小
$res="select * from Video where vid_status=2";
$sql=$conn->query($res);
...
$array=array();
$sql="select * from Video where vid_status=2 limit $pageSql,$pageSize";
$res=$conn->query($sql);
if ($res) {
    ...
    // var_dump($array);
    if ($array==null) {
        echo '<script>alert("暂无未过审内容");location="explain.php"</script>';
    }
}else{
        ...
        <div class="content">
            <div class="path">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><span style="color:orangered"><u>未过审</u></span></li>
                    ...
                    if (1) {
                        foreach($array as $v) {
                            ...
                            <tr>
                                ...
                                <td><textarea style="height:180px;resize: none;background-color: white;border: white" readonly="readonly"><?=$v["vid_info"]?></textarea></td>
                                <td>
                                    <?php
