            ...
            <form class="bs-example bs-example-form" role="form" id="search" action="searchExplain.php" method="post">
                <div class="col-lg-6" id="searchBorder">
                    <div class="input-group" style="margin-top:10px;margin-left:3px">
                        <input type="text" class="form-control" style="margin-top:10px" placeholder="请输入需要搜索的内容" name="content">
        ...
        <div class="tableStyle" style="height:800px;width:1585px;overflow:auto">
            ...
            <table class="table table-hover table-bordered" style="margin-left:18px;margin-top:20px;width:1550px" id="showMag">
                ...
                <tr>
                    ...
                    <td class="style_500px"><textarea type="text" style="border:white;width:490px;height:100px;overflow:auto;background-color:whitesmoke;resize:none" readonly="readonly"><?=$v["com_info"]?></textarea></td>
