...
$array=array();
$cid=$_GET['cid'];
$sql="SELECT * FROM comment where com_id='$cid'";
$res=$conn->query($sql);
if ($res) {
                ...
                if (1) {
                    foreach($array as $v){
                        ...
                        <tr>
                            ...
                            <td class="style_500px"><textarea type="text" style="border:white;width:495px;height:260px;overflow:auto;background-color:whitesmoke;resize:none" readonly="readonly"><?=$v["com_info"]?></textarea></td>
                        ...
                        <tr>
                            <form class="bs-example bs-example-form" role="form" id="modify" action="modify.php" method="post">
                                ...
                                <td class="style_150px"><?=$v["mus_id"]?></td>
                                <td><textarea name="cgrade" style="width:40px;height:30px;resize: none"></textarea></td>
                                <td><textarea name="uid" style="width:140px;height:30px;resize: none"></textarea></td>
                                <td class="style_150px"><?=$v["mus_name"]?></td>
                                <td class="style_500px"><textarea name="newcomment" style="width: 500px;height: 300px;resize: none"></textarea></td>
                                <td class="style_200px"><?=date("Y-m-d H:i:s")?></td>
                        </tr>
                        <?php
                    }}
                ?>
