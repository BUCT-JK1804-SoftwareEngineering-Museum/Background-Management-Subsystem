...
$query = mysqli_query($conn,"select * from Exhibition where exh_id = {$exh_id} limit 1");
if(!$query){
    exit('<h1>查询数据失败</h1>');
}
        ...
        <div class="content">
            <div class="path">
                <ol class="breadcrumb">
                    ...
                    <li class="active">修改展览信息</li>
                </ol>
            </div>
<div class="container edit">
    <h4 class="alert alert-primary text-center">修改展览信息</h4>
    <form method="post" action="edit_exh.php">
        <div class="form-group row">
            <label for="exh_id" class="col-sm-2 col-form-label">展览编号</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name="exh_id" id="exh_id" value="<?php echo $user['exh_id']; ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="exh_name" class="col-sm-2 col-form-label">展览名称</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name="exh_name" id="exh_name" value="<?php echo $user['exh_name']; ?>">
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="exh_info" name="exh_info" value="<?php echo $user['exh_info']; ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="exh_picture" class="col-sm-2 col-form-label">展览图片</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="exh_picture" name="exh_picture" value="<?php echo $user['exh_picture']; ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="exh_time" class="col-sm-2 col-form-label">展览时间</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="exh_time" name="exh_time" value="<?php echo $user['exh_time']; ?>">
            </div>
        </div>
