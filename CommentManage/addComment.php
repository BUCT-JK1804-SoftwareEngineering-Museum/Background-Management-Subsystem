<?php
session_start();require '../dadb.php';
        ...
        <div class="content">
            ...
            <form class="form-horizontal" action="add.php" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input  class="form-control" id="inputPassword3" placeholder="博物馆编号" name="mid">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-1 control-label">评论评分</label>
                    <div class="col-sm-10">
                        <input  class="form-control" id="inputPassword3" placeholder="评论评分" name="cgr">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-1 control-label">用户编号</label>
                    <div class="col-sm-10">
                        <input  class="form-control" id="inputPassword3" placeholder="用户编号" name="uid">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-1 control-label">博物馆名称</label>
                    <div class="col-sm-10">
                        <input  class="form-control" id="inputPassword3" placeholder="博物馆名称" name="mna">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-1 control-label">评论内容</label>
                    <div class="col-sm-10">
                        <input  class="form-control" id="inputPassword3" placeholder="评论内容" name="cin">
                    </div>
                </div>
