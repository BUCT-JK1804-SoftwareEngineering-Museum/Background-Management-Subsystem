    ...
    <div class="topWrapper">
        ...
        <div class="content">
            ...
            <form class="form-horizontal" action="modify.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-1 control-label">评论评分</label>
                    <div class="col-sm-10">
                        <input  class="form-control" id="inputPassword3" value="<?=$v['com_grade']?>" name="cgr">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-1 control-label">用户编号</label>
                    <div class="col-sm-10">
                        <input  class="form-control" id="inputPassword3" value="<?=$v['user_id']?>" name="uid">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-1 control-label">博物馆名称</label>
                    <div class="col-sm-10">
                        <input  class="form-control" id="inputPassword3" value="<?=$v['mus_name']?>" name="mna">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-1 control-label">评论内容</label>
                    <div class="col-sm-10">
                        <input  class="form-control" id="inputPassword3" value="<?=$v['com_info']?>" name="cin">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-1 control-label">评论时间</label>
                    <div class="col-sm-10">
                        <input  class="form-control" id="inputPassword3" value="<?=$v['com_time']?>" name="ctime">
                    </div>
                </div>
