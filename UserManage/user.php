...
$array=array();
	$sql="select * from User  where user_level != '3' limit $pageSql,$pageSize";
	$res=$conn->query($sql);
	if ($res) {
...
<div class="searchContent">
	<form class="bs-example bs-example-form" role="form" id="search" action="searchUser.php" method="post">
	...
	<button type="button" class="btn btn-info"><a href="addUser.php" class="buttonStyle">添加用户</a></button>
</div>
