...
//分页
$pageSize = 5;//每一页面内容大小
$res="select * from Collection limit 100";
$sql=$conn->query($res);
...
$array=array();
$sql="select * from Collection limit $pageSql,$pageSize";
$res=$conn->query($sql);
if ($res) {
    ...
    // var_dump($array);
    if ($array==null) {
        echo '<script>alert("藏品表为空");"</script>';
    }
}else{
        ...
        <div class="content">
            <div class="path">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><span style="color:orangered"><u>藏品管理</u></span></li>
                </ol>
            </div>
