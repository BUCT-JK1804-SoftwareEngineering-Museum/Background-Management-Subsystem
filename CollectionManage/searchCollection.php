...
if (empty($content)) {
    ...
    $sql="select * from collection where col_id like '%$content%'";
    $res=$conn->query($sql);
    if ($res) {
                ...
                if (1) {
                    foreach($array as $v){
                        ...
                        <tr>
                            ...
                            <td><a type='submit' class='btn' style="background-color: red" href=deleteCollection.php?cid=<?=$v["col_id"]?>><span style="color: whitesmoke">删除</span></a>
                                <br>
