        ...
        <div class="content">
            ...
            <form class="form-horizontal" action="add.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input  class="form-control" id="inputPassword3" placeholder="发布者" name="npu">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-1 control-label">新闻时间</label>
                    <div class="col-sm-10">
                        <input  class="form-control" id="inputPassword3" placeholder="新闻时间" name="ntime">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-1 control-label">新闻标题</label>
                    <div class="col-sm-10">
                        <input  class="form-control" id="inputPassword3" placeholder="新闻标题" name="nti">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-1 control-label">新闻内容</label>
                    <div class="col-sm-10">
                        <input  class="form-control" id="inputPassword3" placeholder="新闻内容" name="nco">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-1 control-label">新闻图片</label>
                    <div class="col-sm-10">
                        <input  class="form-control" id="inputPassword3" placeholder="新闻图片链接" name="npi">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-1 control-label">新闻来源</label>
                    <div class="col-sm-10">
                        <input  class="form-control" id="inputPassword3" placeholder="新闻来源" name="nso">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-1 control-label">新闻性质</label>
                    <div class="col-sm-10">
                        <input  class="form-control" id="inputPassword3" placeholder="新闻性质" name="nle">
                    </div>
                </div>
